...
#ifndef NDM_HASH_TABLE_H_
#define NDM_HASH_TABLE_H_
/***************************************************************************
...
{
public:
  size_t operator()(const string the_key) const { //funzione di hashing; resta da capire cosa sia il tipo size_t
